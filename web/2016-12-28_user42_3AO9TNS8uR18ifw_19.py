...
time = 0.05
started = False
ROCK_SPEED = 1.7 #! For the ai game
x = 0 #! just for count of timer
...
class Ship:
    ...
    def update(self):
        ...
        # print self.vel #! Check velocity of ship
        self.vel[0] *= friction
        self.vel[1] *= friction
...
def ai():
    thrust_timer = simplegui.create_timer(1, thrust)
    thrust_timer.start()
    # thrust_timer.stop()
...
def rock_spawner():
    ...
    # rock_vel_multiplier = (score // 1000 + 1) * rock_vel_multiplier_factor #! turn off for constant rock speed
